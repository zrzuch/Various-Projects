...
public:
  ...
  void
  setUniform (const std::string& uniform, const Matrix4& value);

  void
  setUniform (const std::string& uniform, const Matrix3& value);

  void
  setUniform (const std::string& uniform, const Vector3& value);

  void
  setUniform (const std::string& uniform, float value);

  void
  setUniform (const std::string& uniform, int value);

  void
  setUniform (const std::string& uniform, bool value);
