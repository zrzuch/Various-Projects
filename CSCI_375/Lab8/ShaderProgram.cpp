...
void
ShaderProgram::setUniformMatrix (const std::string& uniform, const Matrix3& value)
{
  GLint location = this->getUniformLocation (uniform);
...
void
ShaderProgram::setUniformMatrix (const std::string& uniform, const Vector3& value)
{
  GLint location = this->getUniformLocation (uniform);
